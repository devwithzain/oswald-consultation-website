...
import { howItWorkData } from "@/constants";
import { aboutchoseusimg, arrowright } from "@/public";

export default function HowItWork() {
	return (
		<div className="w-full">
			<div className="w-full flex flex-col lg:flex-row items-center gap-10 padding-x padding-y">
				<motion.div
					...
					<div className="flex flex-col gap-8">
						{howItWorkData.map((reason, index) => (
							<motion.div
								key={reason.id}
